...
5. **Generate Images**: For each of the 7 posts:
   a. Call `freepik_generate_image` with the image prompt and aspect_ratio "1:1"
...
- If any API fails, log the error and try with a modified prompt
...
- You MUST call save_content_results at the end with all 7 posts
